...
RUN NEXT_PUBLIC_DISABLE_USAGE_COLLECTION=NEXT_PUBLIC_DISABLE_USAGE_COLLECTION \
  ...
  NEXT_PUBLIC_CONNECTOR_BACKEND_BASE_URL=NEXT_PUBLIC_CONNECTOR_BACKEND_BASE_URL \
  NEXT_PUBLIC_MODEL_BACKEND_BASE_URL=NEXT_PUBLIC_MODEL_BACKEND_BASE_URL \ 
  NEXT_PUBLIC_API_VERSION=NEXT_PUBLIC_API_VERSION \
  NEXT_PUBLIC_CONSOLE_BASE_URL=NEXT_PUBLIC_CONSOLE_BASE_URL \
  NEXT_PUBLIC_CONSOLE_EDITION=NEXT_PUBLIC_CONSOLE_EDITION \
  pnpm run build 
