...
export const NewsLetterCard = () => {
  ...
  const NewsLetterCardSkeleton = () => {
    return (
      <div className="flex h-[340px] flex-col gap-y-2 rounded-sm border border-semantic-bg-line p-4">
  ...
  return (
    <div className="flex h-[340px] flex-col rounded-sm border border-semantic-bg-line p-4 bg-semantic-bg-primary">
