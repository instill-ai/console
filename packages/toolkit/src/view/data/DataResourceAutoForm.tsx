...
export type DataResourceAutoFormProps = {
...
export const DataResourceAutoForm = (props: DataResourceAutoFormProps) => {
  ...
  async function handleSubmit(data: ResourceResourceFormData) {
    ...
    try {
      ...
      toast({
        title: "Successfully update Data connector",
        variant: "alert-success",
        size: "small",
      });
    } catch (error) {
      toastInstillError({
        title: "Something went wrong when update the Data connector",
        toast,
        error,
      });
    }
