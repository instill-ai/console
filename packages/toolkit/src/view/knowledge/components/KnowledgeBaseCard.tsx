...
export const KnowledgeBaseCard = ({
  ...
  return (
    <div
      className="flex h-[175px] cursor-pointer flex-col gap-y-2.5 rounded-md border border-semantic-bg-line bg-semantic-bg-base-bg p-3 w-[360px]"
      onClick={onClick}
    >
      <div className="flex items-center gap-x-2">
        <Icons.Plus className="h-4 w-4 stroke-semantic-fg-secondary" />
        <h3 className="  text-semantic-fg-primary">Create Knowledge</h3>
      </div>
