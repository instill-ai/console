...
import type { Nullable, ResetNamespaceTableCellRequest } from "instill-sdk";
import { useMutation, useQueryClient } from "@tanstack/react-query";

import { getInstillCatalogAPIClient } from "../../sdk-helper";
import { queryKeyStore } from "../queryKeyStore";

export function useResetNamespaceTableCell() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      payload: ResetNamespaceTableCellRequest;
      ...
      await client.table.resetNamespaceTableCell(payload);
