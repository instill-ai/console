        ...
        return (
            <div className="w-full max-w-md p-4">
                ...
                >
                    ...
                    <Slider.Thumb
                        className="absolute top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-semantic-accent-default bg-semantic-bg-base-bg"
                    />
                </Slider.Root>
        ...
        return (
            <div className="w-full max-w-md p-4">
                ...
                >
                    ...
                    <Slider.Thumb
                        className="absolute top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-semantic-bg-secondary bg-semantic-bg-base-bg"
                    />
                </Slider.Root>
                <div className="mt-4 text-center">Value: {value}</div>
            </div>
        ...
        return (
            <div className="w-full max-w-md p-4">
                ...
                >
                    ...
                    <Slider.Thumb
                        className="absolute top-1/2 h-8 w-8 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-semantic-bg-primary bg-semantic-fg-primary"
                    />
                </Slider.Root>
                <div className="mt-4 text-center">Value: {value}</div>
            </div>
