...
export async function GET(request: Request) {
  ...
  return new ImageResponse(
    (
      <div
        tw="flex flex-col w-full h-full p-8 bg-cover bg-no-repeat"
        style={{
          backgroundImage:
            'url("' +
      ...
      >
        <div tw="w-full gap-x-2 flex flex-row h-[200px]">
          <div tw="flex flex-row w-[840px] break-words text-left">
            <span
        ...
        <div tw="flex h-[200px] items-end">
          <a
            href={`${process.env.NEXT_PUBLIC_CONSOLE_BASE_URL}/${userName}`}
            target="_blank"
            rel="noreferrer"
        ...
        <div tw="flex justify-end items-end h-[100px]">
          {/* <span tw="bottom-0 right-0 mt-10"> */}
          <svg
            width="48"
            height="49"
            viewBox="0 0 48 49"
